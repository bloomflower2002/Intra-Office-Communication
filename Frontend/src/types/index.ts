...
export type MemoStatus = 'Draft' | 'Pending Approval' | 'Approved' | 'Rejected' | 'Completed';
...
export interface Memo {
  ...
  approvalChain: { role: Role; userId: string; action?: 'Approved' | 'Rejected' | 'Forwarded'; comment?: string; timestamp?: string }[];
  readReceipts: ReadReceipt[];
  stageHistory: { stage: MemoStage; timestamp: string }[];
}
