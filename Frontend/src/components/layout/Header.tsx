...
export default function Header() {
  ...
  return (
    <header className="h-16 shrink-0 bg-white border-b border-ink-100 flex items-center gap-4 px-4 lg:px-6">
      <button
      ...
      <form onSubmit={handleSearch} className="hidden sm:flex items-center flex-1 max-w-md">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-ink-50 border border-transparent focus:border-brand-300 focus:bg-white rounded-lg pl-9 pr-3 py-2 text-sm text-ink-700 placeholder:text-ink-400 outline-none transition-colors"
          />
        </div>
      </form>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 ml-auto">
        ...
        <Menu as="div" className="relative">
          ...
          >
            <MenuItems className="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-xl shadow-lg border border-ink-100 py-1.5 focus:outline-none z-50">
